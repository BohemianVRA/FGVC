...
def to_device(
    *tensors: Union[torch.Tensor, dict], device: torch.device
...
def to_numpy(*tensors: Union[torch.Tensor, dict]) -> List[Union[np.ndarray, dict]]:
...
def concat_arrays(
    *lists: List[Union[np.ndarray, dict]]
